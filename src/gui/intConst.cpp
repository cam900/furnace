...
const int _THRTY_TWO_THOUSAND_SEVEN_HUNDRED_SIXTY_SEVEN=32767;
...
const int _MINUS_THRTY_TWO_THOUSAND_SEVEN_HUNDRED_SIXTY_SEVEN=-32767;
const int _MINUS_THRTY_TWO_THOUSAND_SEVEN_HUNDRED_SIXTY_EIGHT=-32768;
